...
function askUserFor(args) {
  return new Promise((resolve, reject) => {
    ...
    [
      ...
      {
        name: "reportFormat",
        message: "When rendered, which format would you like to use? Enter a name (like `default`), a git repo (like `user/repo:file/here.ejs`), or a url.",
        default: "default",
      },
      {
        name: "hourlyRate",
        ...
        default: "50.00",
        filter: (inp) => parseFloat(inp),
      },
      {
        name: "clientName",
        message: "What is the name of your client?",
        default: "none",
        filter: (f) => {
          if (f === "none") {
            return null;
