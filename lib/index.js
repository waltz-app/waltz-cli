        ...
        if (err) {
          ...
          if (origin) {
            ...
            if (data) {
              ...
              console.log("Cannot do a regex match against", origin.refs.push);
            }
          } else {
            console.log("Cannot find a remote named origin to get a username and repositiory name from.");
          }
        }
      });
      break;
